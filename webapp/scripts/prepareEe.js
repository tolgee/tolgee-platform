...
const eePluginEe = path.join(__dirname, '../src/eeSetup/eePlugin.ee.tsx');
const eePluginOss = path.join(__dirname, '../src/eeSetup/eePlugin.oss.tsx');
const eePluginLocal = path.join(
  __dirname,
  '../src/eeSetup/eePlugin.current.tsx'
);
