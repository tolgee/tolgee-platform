...
const OrganizationRemoveUserButton = (props: { userId: number, userName: string }) => {

    const organization = useOrganization()

    const removeUser = () => {
        confirmation({
            message: <T parameters={{userName: props.userName}}>really_remove_user_confirmation</T>,
            onConfirm: () => actions.loadableActions.removeUser.dispatch(organization.id, props.userId)
        })
    }
