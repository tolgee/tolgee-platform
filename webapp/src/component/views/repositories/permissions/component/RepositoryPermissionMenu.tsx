...
const RepositoryPermissionMenu = (props: {
  user: components['schemas']['UserAccountInRepositoryModel'];
}) => {
    ...
    <PermissionsMenu
      ...
      onSelect={(permissionType) => {
        confirmation({
          ...
          onConfirm: () =>
            repositoryActions.loadableActions.setUsersPermissions.dispatch({
              path: {
