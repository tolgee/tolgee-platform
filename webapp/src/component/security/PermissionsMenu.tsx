...
export const PermissionsMenu: FunctionComponent<{
    selected: NonNullable<components["schemas"]["RepositoryModel"]["computedPermissions"]>,
    onSelect: (value: NonNullable<components["schemas"]["RepositoryModel"]["computedPermissions"]>) => void,
    buttonProps?: ComponentProps<typeof Button>,
    minPermissions?: NonNullable<components["schemas"]["RepositoryModel"]["computedPermissions"]>
}> = (props) => {
    ...
    if(props.minPermissions){
       types = types.filter(k => (new RepositoryPermissions(k as any)).satisfiesPermission(props.minPermissions as any));
    }
