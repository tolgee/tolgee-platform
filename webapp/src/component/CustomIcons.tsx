...
import { ReactComponent as ContentNoticeSvg } from '../svgs/icons/contentNotice.svg';
...
export const ContentNoticeIcon: React.FC<IconProps> = (props) => (
  <CustomIcon icon={ContentNoticeSvg} {...props} />
);
