...
export class RepositoryService {
    ...
    public getV2Repositories = async (pageable: components["schemas"]["Pageable"]): Promise<components["schemas"]["PagedModelRepositoryModel"]> =>
        httpV2.get(`repositories`, pageable);

    public getV2Users = async (repositoryId, search, pageable: components["schemas"]["Pageable"]): Promise<components["schemas"]["PagedModelUserAccountInRepositoryModel"]> =>
    ...
    loadRepository = (id): Promise<components["schemas"]["RepositoryModel"]> => httpV2.get("repositories/" + id);
}
