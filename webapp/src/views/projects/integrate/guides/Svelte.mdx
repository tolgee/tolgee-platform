...
<GoToDocsButton href="https://tolgee.io/docs/web/using_with_svelte/installation" style={{ float: "right" }} />
...
You will need `@tolgee/svelte` to use `<T>` component or `getTranslate` function. `@tolgee/ui` allows you to modify
