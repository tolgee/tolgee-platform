...
export const ClientSecretRotationDialog = ({
  ...
  const delivered = result?.delivery?.delivered === true;
          ...
          <>
            <Typography variant="body2" color="text.secondary" mb={2}>
              <T
                ...
                defaultValue="A new secret is created and delivered to {name} over the lifecycle channel. The old secret keeps working for the window below, then stops on its own. You can also revoke it from the list earlier, once you have confirmed the app switched."
                params={{ name: appName }}
              />
            </Typography>
            {capReached && (
