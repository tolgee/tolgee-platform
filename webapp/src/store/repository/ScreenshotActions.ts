...
export class ScreenshotActions extends AbstractLoadableActions<ScreenshotState> {
  ...
  readonly loadableDefinitions = {
    getForKey: this.createLoadableDefinition((repositoryId, key) =>
      this.service.getForKey(repositoryId, key)
    ),
    uploadScreenshot: this.createLoadableDefinition(
      (...args: Parameters<ScreenshotService['upload']>) =>
        this.service.upload(...args),
      (state, action) => {
        ...
        return {
          ...
          loadables: {
            ...
            getForKey: {
              ...
              data: [
                ...(s.loadables.getForKey.data as ScreenshotDTO[]),
    ...
    delete: this.createDeleteDefinition('getForKey', (id) =>
