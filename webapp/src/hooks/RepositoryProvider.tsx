...
export const RepositoryProvider: FunctionComponent<{ id: number }> = (
  props
) => {
  ...
  const init =
    !repositoryDTOLoadable.data && !repositoryDTOLoadable.error && !isLoading;
  const idChanged =
    repositoryDTOLoadable.dispatchParams &&
    repositoryDTOLoadable.dispatchParams[0] !== props.id;
  ...
  throw new GlobalError(
    ...
    repositoryDTOLoadable.error?.code || 'Loadable error'
  );
};
