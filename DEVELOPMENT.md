...
When working, create a dev branch and work on that.

Before sending PR, squash all your commits in to one, and then push to your repo first, then make the PR
