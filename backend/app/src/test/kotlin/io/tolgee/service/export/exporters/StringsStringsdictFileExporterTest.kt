...
class StringsStringsdictFileExporterTest {
  ...
  private fun getExporter(translations: List<ExportTranslationView>): IOsStringsStringsdictExporter {
    val baseLanguageMock = mock<ILanguage>()
    whenever(baseLanguageMock.tag).thenAnswer { "en" }

    return IOsStringsStringsdictExporter(
