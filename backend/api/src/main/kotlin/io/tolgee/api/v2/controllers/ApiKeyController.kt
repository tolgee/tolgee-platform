...
class ApiKeyController(
  ...
  fun getCurrentPermissions(
    ...
    // This endpoint sits outside ProjectScopedEndpoints, so ProjectContextService never runs for it and nothing else
    // asks whether the caller reaches the project.
