  ...
  @Operation(
    ...
    description =
      "Wipes ALL in-scope content of this project and replaces it with the uploaded export zip " +
        ...
        "version. Users are matched by username (case-insensitive); content authored by a user not present " +
        "on this instance is attributed to the importing admin. The project must be quiescent during the " +
        "import — concurrent edits to it are not supported. Setting `ignoreVersion` bypasses the version " +
