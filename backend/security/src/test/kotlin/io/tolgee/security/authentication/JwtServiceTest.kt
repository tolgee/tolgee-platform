...
class JwtServiceTest {
  ...
  private val userAccountService: UserAccountService = Mockito.mock(UserAccountService::class.java)

  private val userAccount: UserAccount = Mockito.mock(UserAccount::class.java)
  ...
  fun setupMocks() {
    ...
    Mockito.`when`(userAccountService.findActive(Mockito.anyLong())).thenReturn(null)
