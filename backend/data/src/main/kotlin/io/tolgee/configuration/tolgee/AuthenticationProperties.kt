...
class AuthenticationProperties(
  ...
  @DocProperty(
    description = "Whether user credentials are stored in Tolgee's database. If you would like to use LDAP, set this to `false`."
  )
  ...
  @E2eRuntimeMutable
  @DocProperty(
    description = "Whether users need to verify their email addresses when creating their account. Requires a valid [SMTP configuration](#SMTP)."
  )
  ...
  @DocProperty(
    description = "Password of initial user. If unspecified, a random password will be generated and stored in the `initial.pwd` file,\n" +
      "located at the root of Tolgee's data path."
  )
  var initialPassword: String? = null,

  @DocProperty(
    description = "Whether image assets should be protected by Tolgee. When enabled, all images are served with a secure token valid for\n" +
  ...
  @E2eRuntimeMutable
  @DocProperty(
    description = "Whether regular users are allowed to create organizations. When `false`, only administrators can create organizations.\n" +
