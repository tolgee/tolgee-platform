...
@DocProperty(
  description = ":::warning\n" +
    ...
    ":::\n" +
    "\n" +
    "Tolgee can use a LDAP server to authenticate users. " +
    "This is very useful if you already use LDAP as a primary mean of\n" +
...
class LdapAuthenticationProperties {
  @DocProperty(
    description = "Whether LDAP authentication is enabled. " +
      "If enabled, you need to set all remaining properties below."
  )
