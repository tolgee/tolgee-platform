...
open class OpenaiMachineTranslationProperties(
    ...
    @DocProperty(description = "Translation prompt. Should contain {source}, {target} and {text} placeholders.")
    var prompt: String = "Translate the following text from {source} to {target}: \"{text}\". Do not include any other information in the response.",
