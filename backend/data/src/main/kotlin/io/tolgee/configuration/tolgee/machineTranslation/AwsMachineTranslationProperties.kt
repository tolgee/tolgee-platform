...
@DocProperty(
  description = "See [AWS's Amazon Translate](https://aws.amazon.com/translate) page " +
...
open class AwsMachineTranslationProperties(
  ...
  @DocProperty(
    description = "If you are authenticating using a different method than " +
  ...
  @DocProperty(
    description = "AWS access key. (optional if you are authenticating " +
      "with a different method, like STS Web Identity)"
  )
  var accessKey: String? = null,

  @DocProperty(
    description = "AWS secret key. (optional if you are authenticating " +
      "with a different method, like STS Web Identity)"
  )
