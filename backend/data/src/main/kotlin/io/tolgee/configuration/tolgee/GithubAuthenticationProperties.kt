...
class GithubAuthenticationProperties {
  ...
  @DocProperty(description = "URL to the OAuth authorization screen. Useful if you want to authenticate against a self-hosted GitHub Enterprise Server.")
  var authorizationUrl: String = "https://github.com/login/oauth/access_token"

  @DocProperty(description = "URL to GitHub's `/user` API endpoint. Useful if you want to authenticate against a self-hosted GitHub Enterprise Server.")
