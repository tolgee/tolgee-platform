...
@DocProperty(
  displayName = "Content Delivery", description = "These properties are used to configure " +
    "default server content delivery storage."
)
class ContentDeliveryProperties {
  @DocProperty(description = "The root path where the content is accessible by the public. If this property is not null. " +
