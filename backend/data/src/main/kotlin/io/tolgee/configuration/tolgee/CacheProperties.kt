...
@DocProperty(description = "At the expense of higher memory footprint, Tolgee can use a cache to reduce the stress on the database and fetch the\n" +
...
class CacheProperties(
  ...
  @DocProperty(description = "Whether Tolgee should use Redis to store cache data instead of storing it in-memory.\n" +
    ":::info\n" +
  ...
  @DocProperty(description = "Maximum size of the Caffeine cache. When exceeded, some entries will be purged from cache. Set to -1 to disable size limitation.\n" +
