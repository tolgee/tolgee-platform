...
@DocProperty(description = "Bulk-imports exported json files in the database during startup. Useful to quickly provision a development server, and used for testing.",
  displayName = "Import")
class ImportProperties {
  @DocProperty(description = "File path of the directory where the file to import are located.")
  var dir: String? = null

  @DocProperty(description = "Whether an implicit API key should be created.\n" +
    "\n" +
