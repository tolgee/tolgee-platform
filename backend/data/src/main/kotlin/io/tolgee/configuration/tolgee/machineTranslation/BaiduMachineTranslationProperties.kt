...
@DocProperty(
  description = "See [Baidu's](https://fanyi-api.baidu.com/product/11) page (in Chinese) " +
...
open class BaiduMachineTranslationProperties(
  ...
  @DocProperty(
    description = "Whether the resulting translation should be changed according to the user-defined dictionary.\n" +
