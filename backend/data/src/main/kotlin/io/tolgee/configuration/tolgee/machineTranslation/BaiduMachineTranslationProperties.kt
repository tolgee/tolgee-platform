...
@DocProperty(description = "See [Baidu's](https://fanyi-api.baidu.com/product/11) page (in Chinese) for more information and applicable pricing.",
...
open class BaiduMachineTranslationProperties(
  ...
  @DocProperty(description = "Whether the resulting translation should be changed according to the user-defined dictionary.\n" +
    "The dictionary used can be modified at [Manage Terms](https://fanyi-api.baidu.com/manage/term) (login required).")
