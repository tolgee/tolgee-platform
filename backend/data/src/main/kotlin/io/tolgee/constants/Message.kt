...
enum class Message {
  ...
  BATCH_API_TOO_MANY_ITEMS,
  BATCH_API_MAX_CONCURRENT_PER_ORG_EXCEEDED,
  BATCH_API_MAX_CONCURRENT_GLOBAL_EXCEEDED,
  BATCH_API_PROVIDER_NOT_SUPPORTED,
  BATCH_API_NOT_ENABLED_FOR_PROVIDER,
  ;
