...
class ProjectPublishingTestData : BaseTestData() {
  ...
  lateinit var translationsEditor: UserAccount
  lateinit var keysCreator: UserAccount
  ...
  init {
    root.apply {
      ...
      addUserAccount {
        username = "translations_editor"
        name = "Translations Editor"
        translationsEditor = this
      }
      addUserAccount {
        username = "keys_creator"
        name = "Keys Creator"
        keysCreator = this
      }
      addUserAccount {
    ...
    projectBuilder.build {
      ...
      addPermission {
        user = this@ProjectPublishingTestData.translationsEditor
        scopes = arrayOf(Scope.TRANSLATIONS_EDIT)
      }
      addPermission {
        user = this@ProjectPublishingTestData.keysCreator
