    ...
    val hierarchy =
      HierarchyItem(
        ...
        listOf(
          ...
          // Deliberately standalone, and deliberately NOT under ALL_VIEW: ALL_VIEW's expansion is `readOnlyScopes`,
          // which grants server supporters read access, and this scope unlocks task-gated writes.
