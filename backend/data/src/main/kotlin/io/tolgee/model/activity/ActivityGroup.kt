...
@EntityListeners(ActivityGroup.Companion.ActivityRevisionListener::class)
class ActivityGroup : java.io.Serializable {
  @Id
  @SequenceGenerator(
  ...
  companion object {
    ...
    class ActivityRevisionListener {
      ...
      @PrePersist
      fun preRemove(activityRevision: ActivityGroup) {
