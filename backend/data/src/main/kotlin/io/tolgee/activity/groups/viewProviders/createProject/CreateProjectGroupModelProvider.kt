...
class CreateProjectGroupModelProvider(applicationContext: ApplicationContext) :
  GroupModelProvider<CreateProjectGroupModel> {
  override fun provide(groupIds: List<Long>): Map<Long, CreateProjectGroupModel> {
    val query = jooqContext
      .select(
