...
import io.tolgee.component.cdn.cachePurging.AzureCdnCachePurging
import io.tolgee.component.cdn.cachePurging.AzureCredentialProvider
...
class AzureCdnCachePurgingTest() {
  @Test
  fun `correctly purges`() {
    ...
    val purging = AzureCdnCachePurging(config, restTemplateMock, azureCredentialProviderMock)
