...
fun List<ImportGlossaryTerm>.assertTerm(term: String, block: TermAssertion.() -> Unit = {}) {
...
class TermAssertion(private val term: ImportGlossaryTerm) {
    ...
    fun hasTranslation(languageTag: String, text: String) {
