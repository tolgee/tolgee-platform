...
class AssignSharedTranslationMemoryRequest {
  ...
  @Schema(
    description =
      "Priority in suggestion results (lower = higher priority). When null, the assignment is " +
        "placed after every existing one (max + 1) so it stacks at the bottom of the list.",
  )
  @field:Min(0)
